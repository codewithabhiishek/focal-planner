...
> = {
  DO_NOW: {
    ...
    dot: "bg-ember",
    text: "text-ember",
    soft: "bg-ember/10 border-ember/25",
  ...
  SOON: {
    ...
    dot: "bg-honey",
    text: "text-honey",
    soft: "bg-honey/10 border-honey/25",
  ...
  LATER: {
    ...
    dot: "bg-steel",
    text: "text-steel",
    soft: "bg-steel/10 border-steel/25",
  ...
  DELEGATE: {
    ...
    dot: "bg-lagoon",
    text: "text-lagoon",
    soft: "bg-lagoon/10 border-lagoon/25",
    ring: "border-lagoon/40",
